   ...
   self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        ...
        [_moreButton mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(self.contentView.mas_top).mas_offset(15);
            make.centerX.mas_equalTo(_typeLabel.mas_centerX);
            make.width.mas_equalTo(50);
            make.height.mas_equalTo(20);
        }];
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, self.contentView.frame.size.width, 150) collectionViewLayout:layout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    STVerbCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];

//
//  STShowIntroductionViewController.m
//  ShowTicket
//
...
- (void)configBackItem
{
//    UIImage *backImage = [UIImage imageNamed:@"navigationButtonReturn"];
...
//    self.navigationItem.leftBarButtonItem = colseItem;
    ...
    [calendarButton addTarget:self action:@selector(backBtnAction:) forControlEvents:UIControlEventTouchUpInside];
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:calendarButton];
}
